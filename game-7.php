...
<?php
session_start();
$_SESSION['nam']="Weapons of Math Destruction";
  ?>
        ...
        <ul class="nav-menu">
          ...
          <li class="menu-has-children menu-active"><a href="">Games</a>
            <ul>
              ...
              <li><a href="game-4.php">Legebds Crusade</a></li>
              <li><a href="game-5.php">Carnage</a></li>
              <li><a href="game-6.php">Kingdom Keeper</a></li>
              <li class="menu-active"><a href="#hero">Weapons of Math Destruction</a></li>
...
============================-->
  <section id="hero">
    <div class="hero-container">
        <embed class="game" src="swf/game-7.swf" type="" height="100%" width="100%">
    </div>
    <div>
