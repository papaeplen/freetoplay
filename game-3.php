        ...
        <ul class="nav-menu">
          ...
          <li class="menu-has-children menu-active"><a href="">Games</a>
            <ul>
              ...
              <li class="menu-active"><a href="#hero">Learn to Fly</a></li>
              <li><a href="game-4.php">Legends Crusade</a></li>
...
============================-->
  <section id="hero">
    <div class="hero-container">
        <embed class="game" src="swf/game-3.swf" type="" height="100%" width="100%">
    </div>
    <div>
